...
func (x *Balance) GetWalletId() string {
	if x != nil {
		return x.WalletId
	}
	return ""
...
func (x *Balance) GetAmount() *v1.Money {
	if x != nil {
		return x.Amount
	}
	return nil
...
const file_balance_v1_balance_proto_rawDesc = "" +
	...
	"balance.v1\x1a\x16common/v1/common.proto\"f\n" +
	"\aBalance\x12\x1b\n" +
	"\twallet_id\x18\x01 \x01(\tR\bwalletId\x12\x14\n" +
	"\x05asset\x18\x02 \x01(\tR\x05asset\x12(\n" +
	"\x06amount\x18\x03 \x01(\v2\x10.common.v1.MoneyR\x06amountB?Z=github.com/example/poly-contracts/gen/go/balance/v1;balancev1b\x06proto3"
...
var file_balance_v1_balance_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_balance_v1_balance_proto_depIdxs = []int32{
	1, // 0: balance.v1.Balance.amount:type_name -> common.v1.Money
